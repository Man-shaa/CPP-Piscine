...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/22 14:10:59 by msharifi          #+#    #+#             */
/*   Updated: 2024/02/22 14:11:00 by msharifi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PmergeMe::printResV(std::vector<int> vPrint)
{
	...
	std::cout << "After sort with std::vector : " << tmp << std::endl;
}
...
void PmergeMe::printResD(std::deque<int> vPrint)
{
	...
	std::cout << "After sort with std::deque : " << tmp << std::endl;
}